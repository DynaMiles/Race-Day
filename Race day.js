...
// All adults will race in the morning and all people under 18 will race in the afternoon. Follow the instructions below to develop the logic for the program!
...
} else if (runnerAge > 18 || isRegisteredEarly === true) {
